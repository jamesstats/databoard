...
```{r,trumpnat, echo=FALSE,warning=FALSE, message=FALSE,out.width='50%', fig.show='hold'}  
library(ggplot2)
library(dplyr)
library(readxl)
library(ggrepel)
...
```{r,trumpgop, echo=FALSE, warning=FALSE, message=FALSE, out.width='50%',align='right'}  
library(ggplot2)
library(dplyr)
library(readxl)
library(ggrepel)
