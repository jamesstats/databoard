...
ggplot(trend_gam, aes(x = Date, y = Smoothed, color = Party)) +
  ...
  theme_classic() +
  labs(title = "Republican or Democratic candidate for U.S. Congress?", y = "", x = "",caption = 'jamesstats/databoard\nDatasource:AtlasIntel,ClarityLabs,CNBC,CNN,Cygnal,EchelonInsights,EmersonCollege,Marist/NPR/PBS,MarquetteLaw,NBCNews,NYT/SIENA,Quinnipiac')+
